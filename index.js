...
app.post("/register", async (req, res) => {
  ...
  if (!userform) {
    ...
    registerme.password = req.body.password;
...
app.post("/login", async (req, res) => {
  ...
  if (!userform) {
    ...
    res.redirect("/login");
  } else if (userform.password == userpassword) {
...
app.get("/dashboard_admin/:id", async (req, res) => {
  ...
  //   employees.forEach(async function (e) {
  //     const empo = await e.find({ _id: e._id, "grosssalary.month": thismonth });
  //     let totalDays = daysInMonth;
  //     let paidLeaves = (empo && empo.paidleaves);
  //     let presentDays = (empo && empo.presentdays);
  //     let grossSalary = (empo && empo.salary);
  //     console.log(paidLeaves);
  //     console.log(presentDays);
  //     console.log(grossSalary);
  //     if (!paidLeaves || !presentDays || !grossSalary) {
  //       console.log('Error: One of the values is undefined.');
  //   } else {
